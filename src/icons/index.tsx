...
export function Device({ className }: Props) {
  return (
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z"></path>
      <path d="M11.5 21H6a2 2 0 01-2-2V5a2 2 0 012-2h12a2 2 0 012 2v8M9 18h2M15 19l2 2 4-4"></path>
    </svg>
  );
}
...
export function World({ className }: Props) {
  return (
    ...
    >
      <path stroke="none" d="M0 0h24v24H0z"></path>
      <path d="M21 12a9 9 0 10-9 9M3.6 9h16.8M3.6 15h7.9M11.5 3a17 17 0 000 18M12.5 3a16.984 16.984 0 012.574 8.62"></path>
      <path d="M15 18a3 3 0 106 0 3 3 0 10-6 0M20.2 20.2L22 22"></path>
    </svg>
  );
}

export function Checks({ className }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
...
export function Tax({ className }: Props) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width="24"
